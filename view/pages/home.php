                ...
                <div class="blog-grid">
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title">Sự kiện LEGO Day - Khám phá thế giới sáng tạo cùng LEGO</h3>
                            <p class="blog-excerpt">Tham gia sự kiện LEGO Day để trải nghiệm các hoạt động thú vị, tham gia các cuộc thi xây dựng sáng tạo và nhận quà tặng đặc biệt từ LEGO.</p>
                            <a href="#" class="read-more">Đọc tiếp <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    <div class="blog-card">
                        <div class="blog-image">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title">Khuyến mãi đặc biệt nhân dịp ra mắt phim Barbie</h3>
                            <p class="blog-excerpt">Nhân dịp ra mắt bộ phim Barbie, MyKingdom giảm giá đặc biệt cho tất cả sản phẩm Barbie trong tháng 7. Cơ hội sở hữu những món đồ chơi Barbie với giá ưu đãi.</p>
                            <a href="#" class="read-more">Đọc tiếp <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                    <div class="blog-card">
                        ...
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title">Top 10 hoạt động hè thú vị cho bé phát triển kỹ năng</h3>
                            <p class="blog-excerpt">Khám phá 10 hoạt động hè vừa vui vừa bổ ích giúp bé phát triển kỹ năng vận động, tư duy logic và khả năng sáng tạo trong kỳ nghỉ hè.</p>
                            <a href="#" class="read-more">Đọc tiếp <i class="fa fa-angle-right"></i></a>
                        </div>
                    </div>
                </div>
